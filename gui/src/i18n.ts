...
const en = {
  ...
  menuFetch: () => "Fetch",
  menuRestoreStash: () => "Restore stashed changes…",
  ...
  phaseTag: () => "tag",
  phaseStashRestore: () => "stash apply",
  phaseOpContinue: () => "continue",
  phaseOpSkip: () => "skip",
  phaseOpAbort: () => "abort",
  stashRestoreTitle: () => "Changes stashed while switching branches:",
  stashNone: () => "The application has stashed nothing in this repository.",
  stashRestoredMark: () => "already restored",
...
const ru: Dict = {
  ...
  menuRestoreStash: () => "Вернуть спрятанное…",
  ...
  phaseOpSkip: () => "skip",
  phaseOpAbort: () => "abort",
  stashRestoreTitle: () => "Спрятанное при переключении веток:",
  stashNone: () => "Приложение ничего не прятало в этом репозитории.",
  stashRestoredMark: () => "уже возвращено",
